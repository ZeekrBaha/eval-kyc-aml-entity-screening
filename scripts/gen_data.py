...
queries = [
    # true matches (incl. transliteration / reorder / typo)
    {
        ...
        "country": "US",
        "kind": "true_match",
        "expected_match_ids": ["L001"],
        "expected_risk": "HIGH",
    },
    {
        "query_name": "Mohammed Ali Hassan",
        "dob": "1965-09-12",
        "country": "EG",
        "kind": "true_match",
        "expected_match_ids": ["L002"],
        "expected_risk": "HIGH",
    },
    {
        "query_name": "Garcia, Maria",
        "dob": "1985-03-22",
        "country": "ES",
        "kind": "true_match",
        "expected_match_ids": ["L003"],
        "expected_risk": "HIGH",
    },
    # decoys (common names that must NOT match)
    {
        "query_name": "Robert Johnson",
        "dob": "1990-02-02",
        "country": "US",
        "kind": "decoy",
        "expected_match_ids": [],
